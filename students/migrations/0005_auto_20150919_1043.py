    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('students', models.ForeignKey(verbose_name='Student', to='students.Student', unique_for_month='date')),
            ],
        ),
        migrations.AlterField(
            model_name='group',
            name='leader',
            field=models.OneToOneField(to='students.Student', verbose_name='Leader', null=True, on_delete=django.db.models.deletion.SET_NULL),
        ),
    ]
